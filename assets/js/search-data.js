...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
        ...
        },{id: "projects-robot-learning-for-navigation",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6A%75%6E%6E%6F%79%75@%6F%75%74%6C%6F%6F%6B.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/JunnoY", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/junno-yu", "_blank");
        },
      },{
      id: 'light-theme',
